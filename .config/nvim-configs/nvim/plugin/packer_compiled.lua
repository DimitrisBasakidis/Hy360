...
_G.packer_plugins = {
  ...
  ["alpha-nvim"] = {
    ...
    loaded = true,
    path = "/Users/user/.local/share/nvim/site/pack/packer/start/alpha-nvim",
  ...
  ["darkplus.nvim"] = {
    loaded = true,
    path = "/Users/user/.local/share/nvim/site/pack/packer/start/darkplus.nvim",
    url = "https://github.com/martinsione/darkplus.nvim"
  },
  ["dracula.nvim"] = {
    loaded = true,
    path = "/Users/user/.local/share/nvim/site/pack/packer/start/dracula.nvim",
  ...
  ["horizon.nvim"] = {
    loaded = true,
    path = "/Users/user/.local/share/nvim/site/pack/packer/start/horizon.nvim",
  ...
  ["melange-nvim"] = {
    loaded = true,
    path = "/Users/user/.local/share/nvim/site/pack/packer/start/melange-nvim",
    url = "https://github.com/savq/melange-nvim"
  },
  ["monokai.nvim"] = {
    loaded = true,
    path = "/Users/user/.local/share/nvim/site/pack/packer/start/monokai.nvim",
  ...
  ["nvim-palenight.lua"] = {
    loaded = true,
    path = "/Users/user/.local/share/nvim/site/pack/packer/start/nvim-palenight.lua",
  ...
  pywal = {
    loaded = true,
    path = "/Users/user/.local/share/nvim/site/pack/packer/start/pywal",
  ...
  ["tender.vim"] = {
    loaded = true,
    path = "/Users/user/.local/share/nvim/site/pack/packer/start/tender.vim",
  ...
  ["vim-code-dark"] = {
    loaded = true,
    path = "/Users/user/.local/share/nvim/site/pack/packer/start/vim-code-dark",
  ...
  ["vscode.nvim"] = {
    loaded = true,
    path = "/Users/user/.local/share/nvim/site/pack/packer/start/vscode.nvim",
